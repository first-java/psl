 ...
 */
public interface UnitIdToBeamSplitService {
	List<ReportBagHe> queryUnitIdToBeamSplit(@Param("page") int page, @Param("limit") int limit,
			@Param("keyWord") String keyWord);

	Integer queryAllCount(@Param("keyWord") String keyWord);

	List<Map<String, Object>> queryUnitIdToBeamSplitByTime(@Param("startTime") String startTime,
