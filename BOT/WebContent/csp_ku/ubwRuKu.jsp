	...
	$(document).ready(function() {
		...
		$("#ajaxA").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ubw.action?methodstr=notest", //5.1
				//提交的数据
				data : {
					"ubw.reelId" : reelId
				},
		...
		$("#ajaxC").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ubw.action?methodstr=notestLot", //5.1
				//提交的数据
				data : {
					"ubw.reelId" : lotId
				},
		...
		$("#ajaxB").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ubw.action?methodstr=putIn", //5.1
				//提交的数据
				data : {
					"ubw.reelId" : reelId,
					"ubw.qty" : qty,
		...
		<table align="left">
			<tr>
				...
				<td id="tt">批号：<input id="lotId" type="text"
					...
					<button class="btn btn-primary" id="ajaxC"></button>
				</td>
			</tr>
		</table>
	</div>
