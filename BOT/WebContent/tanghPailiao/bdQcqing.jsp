		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=bdqcqing", //1.1
					//提交的数据
					data : {
					...
					success : function(result) {
						$("#bdLotId").val("");
						if ("noHave" == result) {
							layer.alert("该编带批次未完结或有误，请确认！！", {
								icon : 2
							});
						} else if (result.startsWith("success")) {
							layer.alert("清机成功！" + result, {
								icon : 1
							});
