...
<body onload="check();">
	...
	输入种类查询： <input type="text" id="lotid" autocomplete="off">
	<button class="btn btn-primary" id="ajaxA">查询</button>
<table>
		<tr>
			<td colspan="4">  <input class="btn btn-primary"
				onclick="downLoad('cspdaoru.action?methodstr=downloadL2')"
				value="导出清单">
			</td>
		</tr>
	</table>
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=selL2", //11.2selectShelft
					//提交的数据
					data : {
						"putIn.leiXing" : lotid
					},
