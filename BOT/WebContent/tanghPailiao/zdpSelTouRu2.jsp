	...
	<table>
		<tr>
			<td colspan="4">选择<select name="leixing"><option>日期类型...</option>
				...
				onclick="downLoad('cspdaoru.action?methodstr=downloadBarcodeTouru')"
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=selTouRu2", //11.2selectShelft
					//提交的数据
					data : {
						"eqpt.startTime" : "0",
			...
			$("#ajaxF").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=selTouRu2TJ", //11.2selectShelft
					//提交的数据
					data : {
						"eqpt.eqpt" : eqpt,
						"eqpt.startTime" : "0",
