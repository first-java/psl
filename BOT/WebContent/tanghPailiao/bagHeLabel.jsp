						...
						<div class="p15 main-box">
							<!-- <form id="printForm" action="#" data-parsley-validate=""
								...
								<input type="hidden" name="bagName" id="bagName" value="" /> <input
									type="hidden" name="qty" id="qty" value="" /> <input type="hidden"
									name="jingWeight" id="jingWeight" value="" /> <input
									type="hidden" name="lotType" id="lotType" value="" /> <input
									type="hidden" name="deposit" id="deposit" value="" />
								<div class="form-group">
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=selectBagHe",
					//提交的数据
					data : {
						"fgPailiao.bagName" : lotId,
					...
					success : function(result) {
						...
						var deposit = result.counter[0].deposit;
	
						$("#bagName").val(bag);
						$("#jingWeight").val(jingWeight);
						$("#deposit").val(deposit)
						$("#lotType").val(lotType);
						$("#qty").val(qty);
						$("#printTplBtn").click();
