		...
		<table align="left" width="30%">
			<tr>
				...
				<td><input autocomplete="off" type="text" id="lotHead"
					...
					onfocus="this.select()">
					<button class="btn btn-primary" id="ajaxA">查询</button></td>
			</tr>
		</table>
	</div>
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=selectS", //11.2selectShelft
					//提交的数据
					data : {
					...
					success : function(result) {
						...
						for (var i = 0; i < result.counter.length; i++) {
							...
							s = "<tr  name='sss'><td><a href='selectcal7.jsp?shelfName=" + shelfName + "&caseNo=" + caseNo + "'>" + shelfName + "</a></td><td>" +
								caseNo + "</td><td>" +
								deposit + "</td><td>" +
								lotId + "</td><td>" +
								bin + "</td><td>" +
