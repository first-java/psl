						...
						<div class="p15 main-box">
							<!-- <form id="printForm" action="#" data-parsley-validate=""
								...
								<input type="hidden" id="shelfName" value=""> <input
									...
									id="bagqty" value=""><input type="hidden" id="lotType"
									value="">
								<div class="form-group">
									<label for="printlabel"
										class="col-sm-2 control-label label-postek">分光机台号：</label>
									<div class="form-group col-sm-10"
										style="padding-left:0;padding-right:0;">
	...
	$("#ajaxA").click();
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				if (lotId.length > 6) {
					layer.alert("输入内容不符合规则！机台号不能超过5位", {
						icon : 2
					}, function() {
						layer.closeAll();$("#lotId").select();
					});
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=setFGlotLabel", //1.1
					//提交的数据
					data : {
						"eqpt.lotId" : lotId,
						"eqpt.workId" : workId
