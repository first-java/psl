					...
					<section class="panel bg-white no-b fadeIn animated"
						...
						<div class="p15 main-box">
                        	...
                        	<div class="form-group">
                                <input type="text" id="printname" name="printname" value="" required
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#printTplBtn").on("click", function() {
			...
			printparamsJsonArray.push({
				"PTK_SetLabelHeight" : "850,16,0,false"
			}); //设置标签纸高度  间隙高度  ！必须设置
			printparamsJsonArray.push({
			...
			printparamsJsonArray.push({
				"PTK_DrawBarcode" : "600,28,0,1,2,2,50,B,eeee"
			}); //打印一个一维码


			/* printparamsJsonArray.push({
				"PTK_PrintPCX" : "10, 100," + urls+ ""
			}); //打印指定图形
 */
			printparamsJsonArray.push({
