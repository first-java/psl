...
%>
<%
	String shelfName = (String) request.getParameter("shelfName");
...
<body onload="check();">
	...
	<table class="table table-striped table-bordered table-hover"
		...
		<thead>
			<input type="hidden" id="shelfName" value="<%=shelfName%>">
			<tr>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				var t = shelfName.split("-");
				$.ajax({
					//提交数据的类型 POST GET
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=selHJ2", //11.2selectShelft
					//提交的数据
					data : {
						"fgShelf.shelfName" : t[0],
						"fgShelf.caseNo" : t[1]
					},
					//返回数据的格式
					...
					success : function(result) {
						...
						for (var i = 0; i < result.counter.length; i++) {
							...
							s = "<tr name='sss'><td>" + bagName + "</a></td><td>" +
								lotType + "</td><td>" +
								qty + "</td><td>" +
								leiXing + "</td><td>" +
								adtimeq + "</td><td>" +
