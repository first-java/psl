	...
	<table>
		<tr>
			<td colspan="4">选择<select name="leixing"><option>日期类型...</option>
				...
				onclick="downLoad('cspdaoru.action?methodstr=downloadDFG')"
				value="导出清单"><input type="text" id="ajaxB" class="btn btn-primary" value="下一页" />
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=select10", //11.2selectShelft
					//提交的数据
					data : {
						"putIn.startTime" : "0",
