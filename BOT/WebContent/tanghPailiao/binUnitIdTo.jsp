	...
	<table>
		<tr>
			<td colspan="4">选择<select name="leixing"><option>日期类型...</option>
				...
				onclick="downLoad('cspdaoru.action?methodstr=downloadBinUnitId')"
				value="导出清单">
			</td>
		</tr>
	</table>
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=binUnitIdTo", //11.2selectShelft
					//提交的数据
					/* data : {
					...
					success : function(result) {
						...
						for (var i = 0; i < result.counter.length; i++) {
							...
							var total_out_die_qty = result.counter[i].total_out_die_qty;
