	...
	<table>
		<tr>
			<td colspan="4">选择<select name="leixing"><option>日期类型...</option>
				...
				onclick="downLoad('cspdaoru.action?methodstr=downloadFgTouru')"
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=fgTouRu", //11.2selectShelft
					//提交的数据
					data : {
						"eqpt.startTime" : "0",
					...
					success : function(result) {
						...
						for (var i = 0; i < result.counter.length; i++) {
							...
							var bdLotId = result.counter[i].fgLotId;
