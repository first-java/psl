		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=binUnitIdTo2", //11.2selectShelft
					//提交的数据
					/* data : {
					...
					success : function(result) {
						...
						for (var i = 0; i < result.counter.length; i++) {
							...
							var nowDieQty = result.counter[i].mesQty;
							var ng_qty = result.counter[i].chayi;
