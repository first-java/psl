...
<%
	...
	String caseNo = (String) request.getParameter("caseNo");//直接传递
	String shelfName = (String) request.getParameter("shelfName");//直接传递
%>
...
<body onload="check();">
	...
	<input type="hidden" value="<%=shelfName%>" id="shelfName">
	<input type="hidden" value="<%=caseNo%>" id="caseNo">
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					type : "POST",
					//提交的网址
					url : "csppailiao.action?methodstr=selectS1", //11.2selectShelft
					//提交的数据
					data : {
					...
					success : function(result) {
						...
						for (var i = 0; i < result.counter.length; i++) {
							...
							s = "<tr οnclick='getData2(this)' name='sss'><td>" + shelfName + "</td><td>" +
								caseNo + "</td><td>" +
								bagName + "</td><td>" +
								status + "</td><td>" +
								deposit + "</td><td>" +
