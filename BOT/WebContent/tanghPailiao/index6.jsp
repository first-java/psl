							...
							<form id="printForm" action="#" data-parsley-validate=""
								...
								<div class="form-group">
									...
									<div class="form-group col-sm-10"
										...
										<input readonly="readonly" type="text" id="lotHead"
											autocomplete="off" value="<%=lotHead%>" required
								...
								<div class="form-group">
									<label for="printlabel"
										class="col-sm-2 control-label label-postek">NG品BIN：</label>
									<div class="form-group col-sm-10"
										style="padding-left:0;padding-right:0;">
		...
		$(document).ready(function() {
			$("#ajaxA").click(function() {
				...
				$.ajax({
					...
					//提交的数据
					data : {
						"calculate.lotHead" : lotHead,
						"calculate.eachWeight" : weight,
						"calculate.id" : id,
						"calculate.bin" : bin,
						"calculate.ngBin" : ngBin,
						"calculate.baofeiBin" : baofeiBin,
						"calculate.sexian" : sexian,
						"calculate.barcode" : barcode,
						"calculate.qty" : qty,
						"calculate.project1" : project1
					},
					//返回数据的格式
