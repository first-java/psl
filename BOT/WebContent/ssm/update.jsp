...
<head>
  ...
  <link rel="stylesheet" href="//res.layui.com/layui/dist/css/layui.css?t=1527693307625" media="all">
  <style>
    body{margin: 10px;}
...
<script src="//res.layui.com/layui/dist/layui.js?t=1527693307625"></script>
<script>
layui.config({
  version: '1527693307625' //为了更新 js 缓存，可忽略
});
