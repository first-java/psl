...
<body>
	...
	<div align="left" class="div">
		<IMG alt="公司logo" src="<%=request.getContextPath()%>/image/logo.png"
			width="65" height="40" border="0"> <span>welcom,${sessionScope.name}</span>
	</div>
	<a href="/select.jsp"></a>
				...
				<tr>
					...
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel2" size="30" />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel4" size="30" />
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel5" size="30" />
						</div>
					</td>
					<td><input type="checkbox" name="changeJump" id="changeJump"
						value="2">删除冲突参数跳转表</td>
					<td>
				</tr>
				<tr>
					<td>参数规则表：</td>
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel6" size="30" />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td><input type="checkbox" name="changeBatch" id="changeBatch"
						value="1">允许更改批次头</td>
					<td>
				</tr>
				<tr>
