	...
	$(document).ready(function() {
		$("#ajaxA").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ela.action?methodstr=select", //5.1
				//提交的数据
				data : {
					"fullName" : fullName,
				},
				...
				success : function(result) {
					...
					s = "<tr name='sss'><td>" +
						"<input type='hidden' name='fullName' value=" + lotNo + " />" + lotNo + "</td><td>" +
		...
		$("#ajaxB").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ela.action?methodstr=save", //11.2
				//提交的数据
				data : {
					"elargol.fullName" : fullName,
					"elargol.workId" : workId,
				},
				//返回数据的格式
