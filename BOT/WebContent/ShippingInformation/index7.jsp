	...
	$(document).ready(function() {
		...
		$("#ajaxA").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ShippingInformationC.action?methodstr=lotNo1", //5.1
				//提交的数据
				data : {
		...
		$("#ajaxB").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ShippingInformationC.action?methodstr=putIn2", //11.2
				//提交的数据
				data : {
					"shippingInformation.lotNo2" : lotNo,
		...
		<table align="left">
			<tr>
				...
				<td id="tt">type：<input id="barcode1" type="text"
					...
					maxlength="13" id="barcode2" type="text"
