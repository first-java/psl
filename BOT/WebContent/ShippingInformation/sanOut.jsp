	...
	$(document).ready(function() {
		...
		$("#ajaxA").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ShippingInformationC.action?methodstr=lotOut", //5.1
				//提交的数据
				data : {
		...
		$("#ajaxB").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ShippingInformationC.action?methodstr=putOut4", //11.2
				//提交的数据
				data : {
					"shippingInformation.lotNo2" : lotNo,
					"shippingInformation.workId" : workId,
	...
	<div class="page-header">
		...
		<table align="left">
			<tr>
				...
				<input type="hidden" onclick="setFocus()" />
				</td>
			</tr>
		</table>
	</div>
...
<script>
	...
	$("#se").blur(function() {
		...
		$.ajax({
			...
			type : "POST",
			//提交的网址
			url : "ShippingInformationC.action?methodstr=lotOut3", //5.1
			//提交的数据
			data : {
	...
	$("#barcode1").blur(function() {
		...
		$.ajax({
			...
			type : "POST",
			//提交的网址
			url : "ShippingInformationC.action?methodstr=lxl", //18.1
			//提交的数据
			data : {
				"shippingInformation.lotNo2" : lotNo
			},
