	...
	$(document).ready(function() {
		...
		$("#ajaxC").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ShippingInformationC.action?methodstr=queryTime", //自己的url
				//提交的数据
				data : {
					"startTime" : obj,
					"endTime" : obj2,
				...
				success : function(result) {
					...
					for (var i = 0; i < result.sf.length; i++) {
						var barcodeString = result.sf[i].barcodeString;
						...
						s = "<tr name='re'><td>" +
							...
							"<input type='hidden' value=" + cType + " />" + cType + "</td><td>" +
							"<input type='hidden' name='qty' value=" + cQty + " />" + cQty + "</td><td>" +
							"<input type='hidden' value=" + createTimeStamp + " />" + createTimeStamp + "</td></tr>";
