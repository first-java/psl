	...
	$(document).ready(function() {
		...
		$("#ajaxB").click(function() {
			...
			$.ajax({
				...
				type : "POST",
				//提交的网址
				url : "ShippingInformationC.action?methodstr=lmputOut", //11.2
				//提交的数据
				data : {
...
<script type="text/javascript">
	function t() {
		...
		$.ajax({
			...
			type : "POST",
			//提交的网址
			url : "ShippingInformationC.action?methodstr=lmlotOut", //18.1
			//提交的数据
			data : {
				"shippingInformation.lotNo2" : lotNo.trim()
			},
			//返回数据的格式
			datatype : "json", //"xml", "html", "script", "json", "jsonp", "text".
			async : true, // 使用异步操作
