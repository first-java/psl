				...
				<tr>
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel2" size="30" /> <input
								type="hidden" name="workId" value="<%=path%>" id="sss" />
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel3" size="30" /> <input
								type="hidden" name="workId" value="<%=path%>" id="sss" />
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel4" size="30" /> <input
								type="hidden" name="workId" value="<%=path%>" id="sss" />
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="uploader blue">
							<input type="text" class="filename" readonly="readonly" /> <input
								type="button" name="file" class="button" value="浏览..." /> <input
								type="file" name="excel" id="excel5" size="30" /> <input
								type="hidden" name="workId" value="<%=path%>" id="sss" />
						</div>
					</td>
				</tr>
