 ...
 *//**
	 ...
	 *//*
		 * @Configuration
		 * 
		 * @MapperScan(basePackages = "com.example.springboot.psl.dao",
		 * sqlSessionTemplateRef = "primarySqlSessionTemplate") public class PslConfig {
		 * 
		 ...
		 * testSqlSessionFactory(@Qualifier("primaryDataSource") DataSource dataSource)
		 ...
		 * "classpath:mybatis/primarymapper/*.xml")); return bean.getObject(); }
		 * 
		 * @Bean(name = "primaryTransactionManager")
		 * 
		 * @Primary public DataSourceTransactionManager
		 * testTransactionManager(@Qualifier("primaryDataSource") DataSource dataSource)
